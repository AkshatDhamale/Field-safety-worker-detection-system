...
//        int HELMET = 0, MASK = 0, VEST = 0, SHOES = 0, GLOVES = 0;
//        for(int i = 0; i < recognitions.size(); i++){
//            if (recognitions.get(i).getTitle().equals("helmet")){
//                HELMET = 1;
//            } else if (recognitions.get(i).getTitle().equals("Mask")){
//                MASK = 1;
//            } else if (recognitions.get(i).getTitle().equals("Gloves")){
//                GLOVES = 1;
//            } else if (recognitions.get(i).getTitle().equals("vest")){
//                VEST = 1;
//            } else if (recognitions.get(i).getTitle().equals("safety_shoe")){
//                SHOES = 1;
//            }
//        }
...
//        try {
//
//            AssetFileDescriptor afd = globalassetmanager.openFd("verified.mp3");
//            if (HELMET == 0 && MASK == 0 && GLOVES == 0 && VEST == 0 && SHOES == 0) {
//                afd = globalassetmanager.openFd("helmet_mask_vest_gloves_shoes.mp3");
//            } else if (HELMET == 0 && MASK == 0 && GLOVES == 0 && VEST == 0 && SHOES == 1) {
//                afd = globalassetmanager.openFd("helmet_mask_vest_gloves.mp3");
//            }
//
